...
import com.example.chatchits.adapter.ChatRecyclerAdapter;
...
public class ChatActivity extends AppCompatActivity {
    ...
    void callApi(JSONObject jsonObject){
        ...
        Request request = new Request.Builder()
                .url(url)
                .post(body)
                .header("Authorization","Bearer AAAAoGSsFfQ:APA91bERzMIKOMMjozlxLlnzofVvDDty3ZuMw70luAds4SgSQ7-f76_ktI3z8tXzhmVP5W_U3sLi-nrqA7nmg1pKvshGbFY_-J6B5FX5c-mjKnNIa9HNERVOwJPUQCO8Q0K4dm0goR1o")
                .build();
